...
#define CAMO_BACKPACK "rhsusf_falconii_coy"
#define CAMO_HEADGEAR "rhsusf_mich_helmet_marpatwd","rhsusf_mich_helmet_marpatwd_alt"
// Rifle
#define RIFLE "rhs_weap_m16a4_carryhandle_grip2"
...
// Carbine
#define CARBINE "rhs_weap_m4_carryhandle_grip3"
#define CARBINE_MAG "30Rnd_556x45_Stanag:10"
// AR
#define AR "rhs_weap_m249_pip_S_vfg1"
...
#define MAT_MAG "rhs_mag_smaw_HEAA:2","rhs_mag_smaw_HEDP:2"
#define MAT_MAG2 "rhs_mag_smaw_HEAA:2","rhs_mag_smaw_HEDP:2"
...
// Sniper Rifle
#define SNIPER "rhs_weap_m40a5"
#define SNIPER_MAG "rhsusf_10Rnd_762x51_m118_special_Mag:5"
// Spotter Rifle
#define SPOTTER "hlc_rifle_M14dmr_Rail"
#define SPOTTER_MAG "hlc_20Rnd_762x51_barrier_M14:9"
...
// Shotgun
#define SG "UK3CB_BAF_L128A1"
#define SG_MAG "UK3CB_BAF_12G_Pellets:4"
// M32
...
#define LEADER_LINKED COMMON_LEADER_LINKED,NODS2
// Class Gear
#define BAG_MEDIC "usm_pack_m5_medic"
#define BAG_MEDIUM "rhsusf_assault_eagleaiii_coy"
#define BAG_HEAVY "milgp_b_patrol_01_cb"
#define GL_VEST "rhsusf_spc_teamleader"
#define LDR_VEST "rhsusf_spc_squadleader"
#define MEDIC_VEST "rhsusf_spc_corpsman"
#define AR_VEST "rhsusf_mbav_mg"
#define IAR_VEST "rhsusf_spc_iar"
#define MRK_VEST "rhsusf_spc_marksman"
#define LDR_HEADGEAR "rhsusf_mich_helmet_marpatwd_alt_headset"
#define LITE_VEST "rhsusf_spc" // Pilot, Crew, Sniper, Spotter
#define SNIPER_UNIFORM "U_B_FullGhillie_sard"
#define PILOT_UNIFORM "U_B_HeliPilotCoveralls"
#define PILOT_HEADGEAR "rhsusf_hgu56p_visor_green"
...
class Soldier_GL_F: Soldier_F { // Grenadier
  vest[] = {GL_VEST};
  weapons[] = {CARBINE};
  handguns[] = {"rhs_weap_M320"};
  magazines[] = {CARBINE_MAG,GLRIFLE_MAG_HE2,BASE_GRENADES};
};
...
class spotter_F: Fic_Spotter {// Spotter
  ...
  attachments[] = {"RH_spr_mbs","RH_TD_ACB_b","rhsusf_acc_M8541"};
  magazines[] = {SPOTTER2_MAG,BASE_GRENADES};
...
class Soldier_lite_F: Fic_Soldier_Carbine { // Breacher
  backpack[] = {BAG_MEDIUM};
  headgear[] = {"rhs_booniehat2_marpatwd"};
  backpackItems[] += {SG,"rhsusf_acc_T1_low"};
