...
if (_unitfaction in ["opf_f","opf_t_f"]) then {
	...
	["GrpCSAT_TNK1",_tnk, "TNK1", "ColorOrange"] spawn f_fnc_localGroupMarker;

	["GrpCSAT_TH1",_hel, "TH1", "ColorBlack"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH2",_hel, "TH2", "ColorBlack"] spawn f_fnc_localGroupMarker;
