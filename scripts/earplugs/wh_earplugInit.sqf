...
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugCheckMods.sqf";

//	Construct & compile action code (earplugUpdateAction) based on presence of ACE.
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugCompileAction.sqf";

//	Construct & compile hint system based on presence of ACE.
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugCompileHint.sqf";
...
SOFT_INCLUDE "scripts\earplugs\wh_earplugCONFIG.sqf";

//	Imports settings if CBA is not present,
//	sets up an options menu if it is.
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugSettings.sqf";
...
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugToggleKey.sqf";
...
SOFT_INCLUDE "scripts\earplugs\include\wh_earplugBriefing.sqf";
